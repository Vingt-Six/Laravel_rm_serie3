        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav mx-auto">
                    <li class="{{Request::is('/') ? "nav-item active px-lg-4" : "nav-item  px-lg-4"}}">
                        <a class="nav-link text-uppercase text-expanded" href="{{route('home')}}">Home
                            <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="{{Request::is('about') ? "nav-item active px-lg-4" : "nav-item  px-lg-4"}}">
                        <a class="nav-link text-uppercase text-expanded" href="{{route('about')}}">About</a>
                    </li>
                    <li class="{{Request::is('products') ? "nav-item active px-lg-4" : "nav-item  px-lg-4"}}">
                        <a class="nav-link text-uppercase text-expanded" href="{{route('products')}}">Products</a>
                    </li>
                    <li class="{{Request::is('store') ? "nav-item active px-lg-4" : "nav-item  px-lg-4"}}">
